...
API_ID = int(environ.get('API_ID', '21480567'))
API_HASH = environ.get('API_HASH', 'bc8fe2a7b13543790eaf0a324f1931f2')
...
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1002078336217'))
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '6339373118').split()]
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1002056148624').split()]
auth_users = [int(user) if id_pattern.search(user) else user for user in environ.get('AUTH_USERS', '-1001999136212').split()]
...
reqst_channel = environ.get('REQST_CHANNEL_ID', '-1001999136212')
REQST_CHANNEL = int(reqst_channel) if reqst_channel and id_pattern.search(reqst_channel) else None
support_chat_id = environ.get('SUPPORT_CHAT_ID', '')
SUPPORT_CHAT_ID = int(support_chat_id) if support_chat_id and id_pattern.search(support_chat_id) else None
INDEX_REQ_CHANNEL = int(environ.get('INDEX_REQ_CHANNEL', LOG_CHANNEL))
FILE_STORE_CHANNEL = [int(ch) for ch in (environ.get('FILE_STORE_CHANNEL', '-1002056148624')).split()]
DELETE_CHANNELS = [int(dch) if id_pattern.search(dch) else dch for dch in environ.get('DELETE_CHANNELS', '0').split()]

# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://waseem:waseem3785@cluster0.kgjqh5z.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")
...
VERIFY_TUTORIAL = environ.get('VERIFY_TUTORIAL', 'https://t.me/Req4M0vies/8')

# Shortlink Info
SHORTLINK_MODE = bool(environ.get('SHORTLINK_MODE', True))
SHORTLINK_URL = environ.get('SHORTLINK_URL', 'instantlinks.co')
SHORTLINK_API = environ.get('SHORTLINK_API', '99306b43c57330af46c3b2a0a5ea2f13f2ff7fee')
